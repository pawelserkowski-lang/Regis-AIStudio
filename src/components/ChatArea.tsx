...
import { Bot, User, CornerDownLeft, FolderOpen, Power, HelpCircle, FileText, Folder, Terminal, Paperclip, X, UploadCloud, Sparkles, ChevronUp, ChevronDown, LogOut, RefreshCw, Archive, ArrowUpLeft, Lightbulb } from 'lucide-react';
